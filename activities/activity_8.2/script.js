...
let inspection_data = [{
    ...
    "latitude": "41.92986822883653",
    "longitude": "-87.70848377951259",
    "location": {
        "latitude": "-87.70848377951259",
        "longitude": "41.92986822883653"
    }
}, {
    ...
    "inspection_type": "License",
    "results": "Not Ready",
    "latitude": "41.92437352872389",
    "longitude": "-87.72681367807314",
    "location": {
        "latitude": "-87.72681367807314",
        "longitude": "41.92437352872389"
    }
}, {
    "inspection_id": "2363099",
    "dba_name": "ARAMARK EDUCATIONAL SERVICES",
    "aka_name": "CICS LOOMIS PRIMARY",
    "license_": "2646463",
    "facility_type": "CHARTER SCHOOL",
    "risk": "Risk 1 (High)",
    "address": "9535 S LOOMIS ",
    "city": "CHICAGO",
    "state": "IL",
    "zip": "60643",
    "inspection_date": "2020-03-03T00:00:00.000",
    ...
    "results": "Pass",
    "latitude": "41.72025066493471",
    "longitude": "-87.65752453407546",
    "location": {
        "latitude": "-87.65752453407546",
        "longitude": "41.72025066493471"
    }
}, {
    "inspection_id": "2363109",
    "dba_name": "TEN CAFE",
    "aka_name": "TEN CAFE",
    "license_": "2713537",
    "facility_type": "Restaurant",
    "risk": "Risk 1 (High)",
    "address": "3308 N WESTERN AVE ",
    "city": "CHICAGO",
    "state": "IL",
    "zip": "60618",
    "inspection_date": "2020-03-03T00:00:00.000",
    "inspection_type": "License Re-Inspection",
    "results": "Pass",
    "latitude": "41.94158571345376",
    "longitude": "-87.68837619919587",
    "location": {
        "latitude": "-87.68837619919587",
        "longitude": "41.94158571345376"
    }
}, {
    "inspection_id": "2363157",
    "dba_name": "MIDTOWN ATHLETIC CLUB AND HOTEL",
    "aka_name": "MIDTOWN ATHLETIC CLUB AND HOTEL",
    "license_": "2535330",
    "facility_type": "Restaurant",
    "risk": "Risk 1 (High)",
    ...
    "inspection_type": "Complaint",
    "results": "No Entry",
    "latitude": "41.98676162461309",
    "longitude": "-87.70151851461625",
    "location": {
        "latitude": "-87.70151851461625",
        "longitude": "41.98676162461309"
    }
}, {
    "inspection_id": "2363103",
    "dba_name": "GOLDEN GRAIN BAKERY AND DONUTS CORPORATION",
    "aka_name": "GOLDEN GRAIN BAKERY/CAFE",
    "license_": "2288717",
    "facility_type": "Restaurant",
    "risk": "Risk 1 (High)",
    "address": "3342 W LAWRENCE AVE ",
    "city": "CHICAGO",
    "state": "IL",
    "zip": "60625",
    "inspection_date": "2020-03-03T00:00:00.000",
    "inspection_type": "Canvass Re-Inspection",
    "results": "Pass",
    "violations": "37. FOOD PROPERLY LABELED; ORIGINAL CONTAINER - Comments: OBSERVED SEVERAL LARGE FOOD CONTAINERS WITH DRY PRODUCTS.(RICE , SALT SUGAR) WITH OUT PROPER COMMON FOOD NAME MARKINGS.ALL BULK AND WORKING FOOD INGREDIENT CONTAINERS MUST BE LABELED WITH CONTENTS NAME.MUST LABEL FOOD STORAGE CONTAINERS WHEN FOOD IS NOT IN ORIGINAL PACKAGE. | 47. FOOD & NON-FOOD CONTACT SURFACES CLEANABLE, PROPERLY DESIGNED, CONSTRUCTED & USED - Comments: OBSERVED TORN RUBBER GASKET ON DOOR TO REACH IN TWO DOOR COOLER IN REAR PREP AREA. INSTRUCTED TO REPAIR WITH PROPER PARTS AND NOT TO USE DUCK TAPE FOR REPAIRS AND MAINTAIN | 53. TOILET FACILITIES: PROPERLY CONSTRUCTED, SUPPLIED, & CLEANED - Comments: MUST PROVIDE TOILET ROOM RECEPTACLE WITH COVER FOR SANITARY NAPKINS IN EMPLOYEES BATHROOM",
    "latitude": "41.968518497633795",
    "longitude": "-87.71263165748292",
    "location": {
        "latitude": "-87.71263165748292",
        "longitude": "41.968518497633795"
    }
}]
...
function initMap() {
    ...
    for(bus of inspection_data) {
        ...
        let contentString = '<div id="content">' + '<div id="siteNotice">' + '</div>' + '<h1 id="firstHeading" class="firstHeading">' + bus.dba_name + '</h1>' + '<div id="bodyContent">' + bus.facility_type + '</div>' + '</div>';
